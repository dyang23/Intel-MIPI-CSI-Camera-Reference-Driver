 ...
 * GMSL camera on MAX96724 deserializer, output to IPU MIPI port 0 (mipi0).
 *
 ...
 *   then use the single-link overlay (xinbu_max96724_d457_mipi0.asl) pinned to
 *   that DESCH_LINK_NUM for production.
 *
 ...
 *       link is what we are probing here.
 *
