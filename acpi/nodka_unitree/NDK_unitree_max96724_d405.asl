 ...
 *
 * SSDT overlay: NODKA "unitree" board (PTL / IPU75XA) — Intel RealSense D405
 * GMSL camera on GMSL input Link 1 (port B), STANDALONE bring-up.
 *
 * This file declares ONLY the D405 on link 1. The D457 on link 0 (port A) is
 ...
 *       board, verified via PHY sweep on the S36/D457 bring-up). A single link
 *       (link 1) routed to PHY0 has the full 4-VC budget to itself.
 *
