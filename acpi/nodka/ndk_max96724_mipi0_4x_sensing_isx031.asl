 ...
 *     and acpi/nodka_unitree/ndk_unitree_max96724_mipi0_4x_li_isx031.asl for
 *     the LI 4x-on-mipi0 counterpart.
 *
 * Board / hardware configuration:
 *   - IPU MIPI input port             : MIPI port 0   -> DES_TO_MIPI_PORT = 0
 *       ^ The 4x Sensing ISX031 module here is connected to the board's mipi0
 *         GMSL connector, whose reverse control channel is on I2C bus 0.
 *         (This is the ONLY difference from the mipi1 sibling in this dir.)
