...
Name(_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
{
    ...
    I2cSerialBusV2 (
        SERCH_CAM_I2C,                 // SlaveAddress (0x1A based on ISX031 hardware)
...
Name (PRT0, Package()
{
    ...
    Package ()
    {
        ...
        Package () { "mipi-img-link-frequencies", Package() { 600000000 } },
